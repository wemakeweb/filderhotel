...
<div data-uk-scrollspy="{cls:'uk-animation-slide-top', repeat: true, delay:100}">Gastbewertung</div>
</h3>
</div><!--uk-text-center-->
</div><!--uk-width-1-1-->   
<div class="uk-container uk-container-center uk-text-center">
...
<script src="https://app.iiq-check.de/hotels/467/iframe.js" type="text/javascript"></script>
</div><!--uk-text-left--> 
</div><!--uk-panel-box-->
