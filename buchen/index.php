...
<script src="http://www.event.filderhotel.de/kalender/booking.js" type="text/javascript"></script>
        ...
        <div data-uk-slideshow="{kenburns:true,autoplayInterval:1000}">
          <div class="uk-slidenav-position">
            <ul class="uk-slideshow">
              <li><img src="../img/filderhotel.jpg" alt="erika otto filderhotel ostfildern"/></li>
              <li><img src="../img/intro/ansicht_ost.jpg" alt="anicht filderhotel ostfildern"/></li>
            </ul>
...
<div class="uk-container uk-width-medium-10-10 uk-width-small-1-1 uk-container-center">
<div class="uk-panel info-box">
<div class="uk-text-center" style="margin:12px 7px 7px 7px;">
 <h1>Buchen Sie uns</h1>
