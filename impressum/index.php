...
<![endif]-->
<meta name="keywords" content="impressum hotel ostfildern,hotel esslingen"/>
...
<link rel="shortcut icon" href="https://getuikit.com/docs/images/favicon.ico" type="image/x-icon">
<link rel="apple-touch-icon-precomposed" href="https://getuikit.com/docs/images/apple-touch-icon.png">
  ...
  <div class="uk-grid" data-uk-grid-margin>
    <div class="uk-small-1-1 uk-width-medium-1-1">
      <div class="uk-vertical-align uk-text-center">
        <div data-uk-slideshow="{kenburns:true,autoplayInterval:1000}">
          <div class="uk-slidenav-position">
            <ul class="uk-slideshow">
              <li><img src="../img/filderhotel.jpg" alt="Filderhotel Ostfildern Esslingen"/></li>
              <li><img src="../img/Neue/ansicht_nacht_1920.jpg" alt="Filderhotel Ostfildern Esslingen"/></li>
            </ul>
...
<div data-uk-scrollspy="{cls:'uk-animation-slide-top', repeat: true, delay:100}">Impressum - Angaben gemäß § 5 TMG:</div>
 </h3>
 </div><!--uk-text-center-->
 </div><!--uk-width-1-1-->
<div class="uk-container uk-container-center uk-text-center">
...
<div class="uk-panel info-box" style="text-align:left">
<div class="uk-text-left" style="margin:12px 7px 7px 7px;">

<p><strong>FILDERHOTEL</strong><br>
Heide Otto KG<br>
In den Anlagen 1<br>
73760 Ostfildern </p>

<p><strong>Telefon</strong>&nbsp;&nbsp;+49(0)711 340 195 0<br/>
<strong>Telefax</strong>&nbsp;&nbsp;+49(0)711 340 195 55<br/>
<strong>Email:</strong>&nbsp;&nbsp;info@filderhotel.de</p>
</div><!--uk-text-left-->
  </div><!--uk-panel-->
</div><!--uk-width-medium-3-10-->

<div class="uk-width-medium-5-10 uk-width-small-1-1 uk-container-center">
<div class="uk-panel info-box" style="text-align:left">
<div class="uk-text-left" style="margin:12px 7px 7px 7px;">
<p><strong>Amtsgericht Esslingen:</strong><br>
HRA-NR: 1657UST-ID:&nbsp;&nbsp;DE  145 331 316<br>
<strong>Aufsichtsbeh&ouml;rde:</strong>
Ordnungsamt Esslingen<br>
<strong>Registergericht:</strong>
Amtsgericht Esslingen<br>
<strong>Vertretungsberechtigter Gesellschafter:</strong>
Erika Otto<br>
<strong>Inhaltlich Verantwortlicher:</strong>
Erika Otto<br></p>
<p>Der Inhalt dieser Seite ist urheberrechtlich gesch&uuml;tzt.
Das Urheberrecht liegt, wenn nichts anderes angegeben,
bei der Heide Otto KG</p>
</div><!--uk-text-left-->
</div><!--uk-panel-box-->
...
<p>Montag bis Sonntag: 7.00 Uhr bis 22.00 Uhr</p>

<h4>Bildnachweise und Urheberrecht</h4>
<p>Bildnachweise © und Quelle Esslinger Stadtmarketing<br/>
Bildnachweise © Stuttgart Marketing GmbH<br/>
Bildnachweis © Stadt Metzingen<br/>
Bildnachweise © Landesmesse Stuttgart GmbH<br/>
Bildnachweis © Adobe Photo Stock<br/>
...
<div class="uk-width-medium-1-2 uk-text-left">
<div class="uk-panel info-box" style="margin:12px 7px 7px 7px;">
<h4>Konzeption & Design:
<small><a href="http://www.work4web.eu">&nbsp;&nbsp;<i class="uk-icon-meh-o uk-icon-small uk-text-success">&nbsp;&nbsp;</i>&nbsp;work4web.eu</a>
</small></h4>
<h4>Vertragsverhältnis </h4>
<p>Auf das Vertragsverhältnis zwischen Gast und
Beherbergungsbetrieb finden ausschließlich die Gastaufnahmebedingungen laut unseren
AGBs Anwendung. Haftungshinweis: Trotz sorgfältiger inhaltlicher Kontrolle übernehmen wir keine Haftung
für die Inhaltliche externer Links. Für den Inhalt der verlinkten Seiten sind ausschließlich deren Betreiber verantworlich.</p>
</div><!--panel-->
</div><!--ukwidthmedium-->
</div><!--ukgrid-->
<hr class="uk-grid-divider">
...
Die Betreiber der Seiten behalten sich ausdrücklich rechtliche Schritte im Falleder unverlangten Zusendung von Werbeinformationen,
etwa durch Spam-Mails, vor.</p>

<h4>Zusatz Google Analytics</h4>
...
(einschließlich Ihrer IP-Adresse) wird an einen Server von Google in den USA übertragen und dort gespeichert.
Google wird diese Informationen benutzen, um Ihre Nutzung der Website auszuwerten, um Reports über
die Websiteaktivitäten für die Websitebetreiber zusammenzustellen und um weitere mit der Websitenutzung und der Internetnutzung
...
vollumfänglich nutzen können. Durch die Nutzung dieser Website erklären Sie sich mit der Bearbeitung der über Sie
erhobenen Daten durch Google in der zuvor beschriebenen Art und Weise und zu dem zuvor benannten Zweck einverstanden.
Das Deaktivierungs-Add-on für Browser von Google Analytics gibt dem Website-Besucher mehr Kontrolle darüber,
welche Daten zu aufgerufenen Websites von Google Analytics erfasst werden. Sollten Sie keine Speicherung Ihrer Daten wünschen,
installieren Sie sich bitte das von Google bereitgestellte De-Aktivierungswerkzeug unter</p>
<a href="https://tools.google.com/dlpage/gaoptout?hl=de" target="_blank" class="uk-button"
data-uk-button>&raquo; mehr Informationen</a>
<br><br>
<a href="https://www.filderhotel.de/pdf/AGB-Filderhotel.pdf" target="_blank"class="uk-button"
data-uk-button>&raquo; AGBs</a>
<br><br>
</div><!--panel-->
</div><!--ukwidthmedium-->
</div><!--ukgrid-->
