...
$text = "<meta http-equiv=\"Content-Type\" content=\"text/plain; charset=iso-8859-1\" />
      Neue Kontaktanfrage - Homepage des FILDERHOTELS <br><br>
...
$ausgabe="	
 Ihr ausfüllen des Kontaktformulars war erfolgreich.<br/>
 Sie bekommen schnellst möglichst eine Anwort.
  <br/>
  <br/>Ihr FILDERHOTEL
  <br/" ; 
}
...
<div class="uk-text-center" style="margin:12px 7px 7px 7px;">
 ...
 <h3>Ihr ausfüllen des Kontaktformulars war erfolgreich.<br/>
 Sie bekommen schnellst möglichst eine Anwort.<br/>
 <br>
 Das Team vom FILDERHOTEL.</h3>
