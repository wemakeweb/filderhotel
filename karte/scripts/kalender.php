...
<table cellpadding="0" cellspacing="0" style="margin-left:48px;" border="0" width="170px" height="170px" >
<?php
...
echo "<tr style=\"color:white;\"><td align='center'  colspan='2'><span class='pointer' onclick=\"ajax('kalender.php?".($_GET['arrival'] == true ? "arrival" : "departure")."=true&month=$last_month&year=$last_year','kalender_content');\">&laquo;</span></td><td colspan='3' align='center'>",$months[$month]," ",$year,"</td><td align='center' colspan='2'><span class='pointer' onclick=\"ajax('kalender.php?".($_GET['arrival'] == true ? "arrival" : "departure") ."=true&month=$next_month&year=$next_year','kalender_content');\">&raquo;</span></td></tr>";
?>
<tr  >
...
foreach ($days as $woche)
{
	...
	foreach ($woche as $tag)
	{
		...
		{
			$bg_color = " style='background-color: #ffea00;' ";
		}
