...
<div data-uk-scrollspy="{cls:'uk-animation-slide-top', repeat: true, delay:100}">Welcome at FILDERHOTEL</div>
</h1>
<p>The FILDERHOTEL Ostfildern near Esslingen, a place of communication and a meeting point for business partners and friends from all over the world. </p>
<p>The Hotel is located in a residential area on the outskirts of town.</p>
<p>The ICS Congress Center, Stuttgart International Airport, main train station of Stuttgart, Schleyer Halle, Mercedes-Benz Arena and Esslingen are in comfortable reach on public transportation or by car.
Messe Stuttgart is 10,4 km away from the FILDERHOTEL, the Autobahn A8 takes you there in a short time.
The 'Technische Akademie Esslingen' is right around the corner and you are there in less than 5 minutes.
Enjoy your stay in a friendly, personal and peaceful ambiance.</p>
<p class="handlee">Yours Erika and Joachim Otto
</div><!--uk-text-left--> 
</div><!--uk-panel-box-->
...
<div class="uk-panel info-box" style="text-align:center">
<figure class="uk-overlay"> <img src="/img/small/breakfast.jpg" alt="Group" style="border-radius:5px;">
<figcaption class="uk-overlay-panel uk-overlay-background uk-overlay-bottom" style="padding:10px 0px;"> </figcaption>
</figure>
<div class="uk-text-left" style="margin:12px 7px 7px 7px;">
<h4>Are you a Morning Grouch or an Early Bird?</h4>
<p>In the morning wake up with the smell of crispy baked croissants and boost your day with
a cup of freshly brewed coffee or a keo tea</p>
<p>We offer a balanced and healthy breakfast at our large breakfast buffet which includes selected rolls, jams, fresh fruit salad, to help you start your day.</p>
</div><!--uk-text-left-->
</div><!--uk-panel-->
</div><!--uk-width-->
<div class="uk-width-medium-1-2 uk-width-small-1-1 uk-hidden-small uk-container-center">
<div class="uk-panel info-box" style="text-align:center">
<figure class="uk-overlay"> <img src="../../img/small/decke_xxl.jpg" alt="Group" style="border-radius:5px;">
<figcaption class="uk-overlay-panel uk-overlay-background uk-overlay-bottom" style="padding:10px 0px;"> </figcaption>
</figure>
<div class="uk-text-center" style="margin:12px 7px 7px 7px;">
<h3>Rate us</h3>
<div id='iiqcheck_widget_467'></div>
<script>
//<![CDATA[
var script = document.createElement('script');
script.type = 'text/javascript';
script.async = true;
script.src = 'https://app.iiq-check.de/hotels/467/widget_configurations/w.js?r=' + encodeURIComponent(document.URL);
(function () {
