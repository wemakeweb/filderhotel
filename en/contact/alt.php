...
<textarea cols="30" rows="5" style="margin: 0px; width: 275px; height: 75px;" placeholder="Message" id="message" name="message"></textarea>
</div>
...
<img src="captcha/rechen-captcha.php" border="1" title="sicherheitscode"/>
...
<textarea cols="10" rows="1" style="margin: 0px; width: 275px; height: 25px;" placeholder="Sicherheitscode eintragen" id="catchpa_spam" name="sicherheitscode">
</textarea></div>
</div><!--uk-form-row-->
