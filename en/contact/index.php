...
<div data-uk-scrollspy="{cls:'uk-animation-slide-top', repeat: true, delay:100}">Contact us</div>
</h3>
</div><!--uk-text-center-->
</div><!--uk-width-1-1-->   
<!--section-willkommen-->  
...
<div class="uk-width-1-1">
<div class="uk-grid uk-text-left uk-margin-large-top uk-margin-large-bottom"  data-uk-grid-margin>
...
<div class="uk-text-left" style="margin:-66px 7px 7px 73px;">
<!--kontakt-->
<section id="kontakt">
<div class="uk-text-left">
<h1 class="uk-margin-large-bottom">Thank you for submitting the contact form.</h1>
...
<input placeholder="Arrival Date *" data-uk-datepicker="{format:'DD.MM.YYYY'}" class="uk-form-medium" style="margin: 0px; width: 275px; height: 25px;"
...
<button class="uk-button" type="button" disabled>
<i class="uk-icon-calendar uk-text-success">&nbsp;&nbsp;</i></button>
<input placeholder="Departure Date *" data-uk-datepicker="{format:'DD.MM.YYYY'}" class="uk-form-medium" style="margin: 0px; width: 275px; height: 25px;" 
...
<textarea cols="30" rows="5" style="margin: 0px; width: 275px; height: 75px;" placeholder="Message *" id="message" name="message" required></textarea>
</div>
...
<img src="captcha/captcha.php" border="1" title="security code"/>
<button class="uk-button" type="button" disabled>Security code</button>
</div><!--uk-form-->
<div class="uk-form-row">
<button class="uk-button" type="button" disabled>
<i class="uk-icon-refresh uk-text-success">&nbsp;&nbsp;</i></button>

<textarea cols="10" rows="1" style="margin: 0px; width: 275px; height: 62px;" placeholder="Security code " id="captcha_spam" name="sicherheitscode">
</textarea></div>
</div>
<div class="uk-form-row" style="margin: 20px; padding: 30px;">
  <button class="uk-button-primary uk-button-large" type="submit"  id="contact-submit">Sending</button></div>
